...
Usage: lean data download [OPTIONS]
  ...
  agreements and payment. Certain steps will be skipped if you already purchased the selected data. After this wizard
  the selected data will be downloaded automatically.
